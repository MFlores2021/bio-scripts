...
ls *.fsa | parallel -j 30 blastall -p blastx -i {} -o arap-{.}.tab -d ~/db/araport11/Araport11_genes.201606.pep.fasta -e 0.0001 -v 200 -b 200 -m 8 -a 3

ls *.fsa | parallel -j 30 blastall -p blastx -i {} -o swiss-{.}.tab -d ~/db/swiss/uniprot-plant_swissprot.fasta -e 0.0001 -v 200 -b 200 -m 8 -a 3

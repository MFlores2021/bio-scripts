...
do
echo ${m};
~/tools/scripts/stringtie_expression_matrix.pl --expression_metric=TPM --result_dirs=${m}'_1,'${m}'_2,'${m}_3 --transcript_matrix_file=${m}_transcript_tpm_all_samples.tsv --gene_matrix_file=${m}_gene_tpm_all_samples.tsv

...
#source: https://github.com/sylvainforet/libngs/blob/master/src/scripts/assembly_stats.py

import cStringIO

statsNames = ['name', 'Contigs', 'totLength', 'Longest', 'Shortest', 'Ns', 'N75', 'N50', 'N25', 'len75', 'len50', 'len25', 'count400', 'count1k', 'count5k','count10k','count20k','count40k','count60k','count70k','count80k','count90k', 'sum1k', 'sum5k', 'sum10k', 'sum20k', 'sum40k', 'sum60k', 'sum70k', 'sum80k', 'sum90k']
